        ...
        return (
            <div className="container-fluid top">
                ...
                <div className="row">
                    ...
                    <form className="rounded mx-auto d-block form-login" onSubmit={this.onSubmitFormLogin.bind(this)}>
                        <table>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td className='input-login'>
                                        <input type="email" name="email" onChange={this.handleChange.bind(this)} value={this.state.email} id="exampleInputEmail1" required autoComplete='off' />
                                    </td>
                                    <td className='input-login'>
                                        <input type="password" name="password" onChange={this.handleChange.bind(this)} value={this.state.password} id="exampleInputPassword1" required autoComplete='off' />
